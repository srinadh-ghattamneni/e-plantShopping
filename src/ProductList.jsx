...
import { addItem } from './CartSlice'; // Ensure CartSlice is set up with `addItem` action
...
function ProductList() {
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowPlants(true); // Show plants page
        setShowCart(false); // Hide cart when viewing plants
    };
